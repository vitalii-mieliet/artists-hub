import{a as O,i as _,P as R,S as F}from"./assets/vendor-SJpk5S-B.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const S=O.create({baseURL:"https://sound-wave.b.goit.study/api",headers:{"Content-Type":"application/json"}}),H=8,$={ARTISTS:"/artists",ARTIST_BY_ID:t=>`/artists/${t}`,FEEDBACKS:"/feedbacks",GENRES:"/genres"};async function D(t=1){const e={limit:H,page:t};try{return(await S.get($.ARTISTS,{params:e})).data}catch(s){throw s}}async function Y(t){try{return(await S.get($.ARTIST_BY_ID(t))).data}catch(e){throw e}}async function G(t=1){const e={limit:20,page:t};try{return(await S.get($.FEEDBACKS,{params:e})).data.data}catch(s){throw s}}const f=document.querySelector(".js-loader-modal");function C(){f&&f.classList.add("is-open")}function B(){f&&f.classList.remove("is-open")}let d=null;function K(t){const e=document.querySelector(t);e&&(d=e,e.classList.add("is-open"),document.body.classList.add("no-scroll"),e.addEventListener("click",P),document.addEventListener("keydown",q))}function T(){d&&(d.classList.remove("is-open"),document.body.classList.remove("no-scroll"),d.removeEventListener("click",P),document.removeEventListener("keydown",q),d=null)}function P(t){const e=t.target===d,s=t.target.closest(".js-close-btn");(e||s)&&T()}function q(t){t.key==="Escape"&&T()}function W(){[".modal-backdrop",".artist-modal",".js-modal-artist-detail-info"].forEach(e=>{const s=document.querySelector(e);s&&(s.scrollTop=0)})}function Z(t){var r;const e=document.querySelector(".js-modal-artist-detail-info");e.innerHTML="";const s=` <h2 class="artist-modal-name">${t.strArtist}</h2>
      ...
      </div>`;e.innerHTML=s,z(t.tracksList);const a=document.querySelector(".js-biography-paragraph"),i=document.querySelector(".js-biography-toggle");i.addEventListener("click",()=>{a.classList.toggle("expanded");const n=a.classList.contains("expanded");i.textContent=n?"Show less":"Show more"})}function z(t){const e=document.querySelector(".artist-modal-fetched-albums-wrapper");e.innerHTML="";const s=J(t);Object.entries(s).forEach(([a,i])=>{const r=document.createElement("div");r.classList.add("artist-modal-album-container"),r.innerHTML=`
        ...
        <ul class="artist-modal-track-list">
          ${i.map(n=>`
            <li class="artist-modal-track-list-item">
              ...
              <p class="artist-modal-track-list-item-time">${V(n.intDuration)}</p>
              ${n.movie?`
