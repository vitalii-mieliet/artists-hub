import{a as D,i as G,P as V,S as Y}from"./assets/vendor-SJpk5S-B.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const A=D.create({baseURL:"https://sound-wave.b.goit.study/api",headers:{"Content-Type":"application/json"}}),Z=8,C={ARTISTS:"/artists",ARTIST_BY_ID:t=>`/artists/${t}`,FEEDBACKS:"/feedbacks",GENRES:"/genres"};async function J({currentPage:t=1,query:e,sortName:s,genre:r}={}){const a={limit:Z,page:t};e&&(a.name=e),s&&(a.sortName=s),r&&(a.genre=r);try{return(await A.get(C.ARTISTS,{params:a})).data}catch(n){throw n}}async function K(t){try{return(await A.get(C.ARTIST_BY_ID(t))).data}catch(e){throw e}}async function W(t=1){const e={limit:20,page:t};try{return(await A.get(C.FEEDBACKS,{params:e})).data.data}catch(s){throw s}}async function U(){try{return(await A.get(C.GENRES)).data}catch(t){throw t}}const $=document.querySelector(".js-loader-modal");function z(){$&&$.classList.add("is-open")}function Q(){$&&$.classList.remove("is-open")}let S=null;function X(t){const e=document.querySelector(t);e&&(S=e,e.classList.add("is-open"),document.body.classList.add("no-scroll"),e.addEventListener("click",O),document.addEventListener("keydown",I))}function N(){S&&(S.classList.remove("is-open"),document.body.classList.remove("no-scroll"),S.removeEventListener("click",O),document.removeEventListener("keydown",I),S=null)}function O(t){const e=t.target===S,s=t.target.closest(".js-close-btn");(e||s)&&N()}function I(t){t.key==="Escape"&&N()}function tt(){[".modal-backdrop",".artist-modal",".js-modal-artist-detail-info"].forEach(e=>{const s=document.querySelector(e);s&&(s.scrollTop=0)})}function et(t){var n;const e=document.querySelector(".js-modal-artist-detail-info");e.innerHTML="";const s=` <h2 class="artist-modal-name">${t.strArtist}</h2>
...
>
  ...
  <path d="M9 19.9426L17 12.9426L9 5.94263V19.9426Z" fill="white" />
      ...
      `).join("");t.innerHTML=s}catch(e){console.error("🔥 Failed to render genres:",e)}}const T="/artists-hub/dev/assets/sprite-CJx7dMIk.svg";function j({totalItems:t,itemsPerPage:e,onPageChange:s}){const r=document.getElementById("pagination");let a=null,n=1,o=null;function u(){return window.innerWidth<768?1:3}const l=`<svg class="tui-page-btn icon-tui" width="14" height="15"><use href="${T}#icon-right-arrow-alt"></use></svg>`,d=`<svg class="tui-page-btn icon-tui" width="14" height="15"><use href="${T}#icon-left-arrow-alt"></use></svg>`;function c(g=1){r.innerHTML="",o=u();const v={totalItems:t,itemsPerPage:e,visiblePages:o,page:g,centerAlign:!0,usageStatistics:!1,template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:({type:i})=>{const m=i==="prev"?`${d}`:`${l}`;return`<a href="#" class="tui-page-btn tui-${i}">${m}</a>`},disabledMoveButton:({type:i})=>{const m=i==="prev"?`${d}`:`${l}`;return`<span class="tui-page-btn tui-is-disabled tui-${i}">${m}</span>`},moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};a=new V(r,v),a.on("afterMove",({page:i})=>{n=i,p(i)}),a.on("beforeMove",i=>{s(i.page)}),p(g)}function p(g){const v=Math.ceil(t/e),i=g+6,m=r.querySelector(".tui-extra-page");if(m&&m.remove(),i>v)return;const f=document.createElement("a");f.href="#",f.className="tui-page-btn tui-extra-page",f.textContent=i,f.addEventListener("click",P=>{P.preventDefault(),a.movePageTo(i)});const b=r.querySelector(".tui-next"),H=r.querySelector(".tui-next-is-ellip");r.querySelectorAll(".tui-prev-is-ellip").forEach(P=>P.remove()),H&&b||b?r.insertBefore(f,b):r.appendChild(f)}return c(),window.addEventListener("resize",()=>{u()!==o&&c(n)}),{goToPage:g=>{a.movePageTo(g)}}}let y=null,x="";async function L(t=1){var e;try{const s=dt(),r=JSON.stringify(s),a=await J({currentPage:t,...s});ct(),it(a.artists);const n=Number(a.limit),o=Number(a.totalArtists);r!==x&&((e=y==null?void 0:y.destroy)==null||e.call(y),y=j({totalItems:o,itemsPerPage:n,onPageChange:L}),x=r),y||(y=j({totalItems:o,itemsPerPage:n,onPageChange:L}),x=r)}catch{lt("Failed to load artists")}}function _(){L(1)}document.addEventListener("click",t=>{const e=t.target.closest(".js-learn-more-btn");if(!e)return;const s=e.dataset.artistId,r=e.dataset.genres,a=r?JSON.parse(r):[];s&&ot(s,a)});function mt(){const t=document.querySelector(".artist-button-filters"),e=t==null?void 0:t.querySelector(".arrow-icon"),s=document.querySelector(".artist-modal-filters-box"),r=document.querySelectorAll(".artist-sort-name[data-toggle-js]"),a=document.querySelectorAll("[data-artist-modal]"),n=document.querySelector("[data-artist-search]"),o=document.querySelector(".artist-search-button"),u=document.querySelector(".artist-reset-filters");t==null||t.addEventListener("click",l=>{l.stopPropagation(),s.classList.toggle("open"),e==null||e.classList.toggle("rotated")}),r.forEach((l,d)=>{const c=a[d],p=l.querySelector("svg");l.addEventListener("click",g=>{g.stopPropagation();const v=c.classList.contains("open");a.forEach(i=>i.classList.remove("open")),r.forEach(i=>{var m;i.classList.remove("active-filter"),(m=i.querySelector("svg"))==null||m.classList.remove("rotated")}),v||(c.classList.add("open"),l.classList.add("active-filter"),p==null||p.classList.add("rotated"))})}),s==null||s.addEventListener("change",l=>{var b;const d=l.target;if(!d.matches('input[type="radio"]'))return;const c=d.name==="sort"?"sort":d.name==="sort-genre"?"genre":null;if(!c)return;let p=c==="sort"?(b=d.closest("label"))==null?void 0:b.textContent.trim():d.value||"All genres";const g=document.querySelector(`[data-type-value="${c}"]`);g&&(g.textContent=p);const v=c==="sort"?0:1,i=document.querySelectorAll("[data-artist-modal]")[v],m=document.querySelectorAll(".artist-sort-name[data-toggle-js]")[v],f=m.querySelector("svg");i==null||i.classList.remove("open"),m==null||m.classList.remove("active-filter"),f==null||f.classList.remove("rotated"),L(1)}),o==null||o.addEventListener("click",l=>{l.stopPropagation(),n!=null&&n.value.trim()&&L(1)}),n==null||n.addEventListener("keydown",l=>{l.key==="Enter"&&(l.preventDefault(),L(1))}),u==null||u.addEventListener("click",()=>{n&&(n.value="");const l=document.querySelectorAll('input[name="sort-genre"]');l.length&&(l.forEach(c=>c.checked=!1),l[0].checked=!0,document.querySelector('[data-type-value="genre"]').textContent="All genres");const d=document.querySelectorAll('input[name="sort"]');d.length&&(d.forEach(c=>c.checked=!1),d[0].checked=!0,document.querySelector('[data-type-value="sort"]').textContent="Default"),L(1)}),document.addEventListener("click",l=>{s.contains(l.target)||t.contains(l.target)||(s.classList.remove("open"),e==null||e.classList.remove("rotated"),a.forEach(c=>c.classList.remove("open")),r.forEach(c=>{var p;c.classList.remove("active-filter"),(p=c.querySelector("svg"))==null||p.classList.remove("rotated")}))})}_();mt();ut();let h=null,w=0;function gt(t){const e=Math.min(100,t/5*100),s=`starMask-${Math.random().toString(36).substr(2,9)}`,r="M9.07 1.318c.345-.817 1.515-.817 1.86 0l2.028 4.819c.145.344.473.58.849.609l5.266.417c.892.07 1.254 1.17.574 1.746l-4.012 3.395a.987.987 0 0 0-.325.986l1.226 5.077c.208.86-.74 1.54-1.503 1.079l-4.508-2.72a1.017 1.017 0 0 0-1.05 0l-4.508 2.72c-.764.46-1.711-.22-1.503-1.08l1.225-5.076a.987.987 0 0 0-.324-.986L.353 8.91c-.68-.575-.318-1.675.574-1.746l5.266-.417c.376-.03.704-.265.849-.61l2.029-4.818Z";return`
